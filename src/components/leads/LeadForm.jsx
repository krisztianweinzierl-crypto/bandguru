      ...
      <CardContent className="p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className={kontaktModus === 'auswahl' ? 'bg-[#D96648] hover:opacity-90' : ''}
                >
                ...
                <Button
                  ...
                  className={kontaktModus === 'manuell' ? 'bg-[#D96648] hover:opacity-90' : ''}
                >
                ...
                <div className="space-y-2">
                  ...
                  {kunden.length === 0 ? (
                    <p className="text-sm text-muted-foreground text-center py-4">
                      ...
                      <button type="button" className="text-[#D96648] underline" onClick={() => setKontaktModus('manuell')}>
                        Neuen Kontakt eingeben
                      </button>
                    </p>
                  ) : (
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <Button type="submit" className="bg-[#D96648] text-primary-foreground px-4 py-2 text-sm font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow hover:bg-primary/90 h-9 from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700">

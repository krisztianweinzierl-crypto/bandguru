  ...
  const handleExportPDF = (angebot) => {
    printBusinessDocument({
      ...
      metaZeilen: [
        ...
        ['Datum', formatDokumentDatum(angebot.angebotsdatum)],
        ['Gültig bis', formatDokumentDatum(angebot.gueltig_bis)]
      ],
      kunde: kunden.find((k) => k.id === angebot.kunde_id),
      organisation,
      positionen: angebot.positionen,
      nettoBetrag: angebot.netto_betrag,
      steuerBetrag: angebot.steuer_betrag,
      bruttoBetrag: angebot.brutto_betrag,
      intro: angebot.kunde_notizen,
      bedingungen: angebot.zahlungsbedingungen,
      abschlussZeilen: [

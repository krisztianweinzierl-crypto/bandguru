      ...
      <Card
        ...
        <CardHeader className="pb-3">
          <div className="flex items-start gap-4">
            <div
              className="bg-[#2E7D69] text-white text-lg font-bold rounded-lg w-12 h-12 flex items-center justify-center flex-shrink-0 cursor-pointer"
  ...
  const LeadListItem = ({ lead }) => {
    ...
    return (
      <div
        ...
        <div className="bg-[#2E7D69] text-white font-bold rounded-lg w-12 h-12 from-orange-500 to-red-600 flex items-center justify-center flex-shrink-0">
          <Target className="w-6 h-6" />
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            ...
            <Button
              onClick={() => {
                setEditingLead(null);
                setShowForm(true);
              }} className="bg-[#2E7D69] text-primary-foreground px-4 py-2 text-sm font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow hover:bg-primary/90 h-9 from-orange-500 to-red-600 hover:bg-[#256B59]">

      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6">
            Willkommen bei <span className="bg-[rgb(var(--primary))] bg-clip-text text-transparent">Bandguru</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              onClick={handleLogin}
              size="lg"
              className="bg-[rgb(var(--primary))] hover:bg-[rgb(var(--primary))]/90 text-lg px-8 py-6"
            >
              Jetzt anmelden
        ...
        <div className="text-center">
          <Card className="border-none shadow-xl bg-[rgb(var(--primary))] text-white max-w-3xl mx-auto">

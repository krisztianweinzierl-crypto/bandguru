      ...
      <Card
        ...
        <CardHeader className="pb-4">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-[#2E7D69] rounded-lg flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
  ...
  const KundeListItem = ({ kunde }) => {
    return (
      <div
        ...
        <div className="bg-[#2E7D69] text-white text-lg font-bold rounded-lg w-12 h-12 from-green-500 to-emerald-600 flex items-center justify-center flex-shrink-0">
          {kunde.firmenname?.[0]?.toUpperCase() || 'K'}
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          ...
          <Button
            onClick={() => {
              setEditingKunde(null);
              setShowForm(true);
            }} className="bg-[#2E7D69] text-white px-4 py-2 text-sm font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow h-9 hover:bg-slate-900">

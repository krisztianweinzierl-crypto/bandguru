      ...
      <Card
        ...
        <CardHeader className="pb-3">
          <div className="flex items-start gap-4">
            <div
              className="bg-[rgb(var(--primary))] text-white text-lg font-bold rounded-lg w-12 h-12 flex items-center justify-center flex-shrink-0 cursor-pointer"
  ...
  const LeadListItem = ({ lead }) => {
    ...
    return (
      <div
        ...
        <div className="bg-[rgb(var(--primary))] text-white font-bold rounded-lg w-12 h-12 from-orange-500 to-red-600 flex items-center justify-center flex-shrink-0">
          <Target className="w-6 h-6" />
        </div>

  ...
  if (isLoading || !kunde) {
    return (
      <div className="min-h-screen bg-background p-4 md:p-8 flex items-center justify-center">
        <p className="text-muted-foreground">Lade Kunde...</p>
      </div>);
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <Button
              ...
              className="gap-2 mb-4 bg-[rgb(var(--primary))] text-white hover:bg-[rgb(var(--primary))]/90 h-8 px-3 text-sm">

              <ArrowLeft className="w-4 h-4" />
              Zurück zur Übersicht
            </Button>
            <h1 className="text-3xl font-bold text-foreground mb-2">Kunde bearbeiten</h1>
            <p className="text-muted-foreground">{kunde.firmenname}</p>
          </div>
          <KundenForm
            kunde={kunde}
        ...
        <div className="w-full max-w-7xl mx-auto px-3 md:px-8 py-4 md:py-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            <Button
              ...
              className="gap-2 bg-[rgb(var(--primary))] text-white hover:bg-[rgb(var(--primary))]/90 h-8 px-3 text-sm">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            <div className="flex items-start gap-6">
              <div className="bg-[rgb(var(--primary))] text-white text-3xl font-bold rounded-lg w-24 h-24 from-green-500 to-emerald-600 flex items-center justify-center">
                {kunde.firmenname?.[0]?.toUpperCase() || 'K'}
              </div>
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">{kunde.firmenname}</h1>
                {kunde.ansprechpartner &&
                <p className="text-lg text-muted-foreground mb-3">{kunde.ansprechpartner}</p>
                }
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                variant="default"
                size="sm"
                onClick={() => setIsEditing(true)} className="bg-[rgb(var(--primary))] text-primary-foreground px-3 text-xs font-medium rounded-md inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow h-8 gap-2 hover:bg-green-700">
        ...
        <div className="grid lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`tel:${kunde.telefon}`} className="font-medium text-foreground">
                        {kunde.telefon}
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground whitespace-pre-line">{kunde.adresse}</p>
                    </div>
                  </div>
                }
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground mb-1">USt-ID</p>
                      <p className="font-medium text-foreground">{kunde.ust_id}</p>
                    </div>
                  </div>
                }
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground">{kunde.zahlungsziel_tage} Tage</p>
                    </div>
                  </div>
                }
              </CardContent>
            ...
            <Card className="border-none shadow-lg">
                ...
                <CardContent className="p-6">
                  <p className="text-foreground whitespace-pre-wrap">{kunde.notizen}</p>
                </CardContent>
              </Card>
            }
                  ...
                  <div
                    ...
                    onClick={() => navigate(createPageUrl(`EventDetail?id=${event.id}`))}>
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <h4 className="font-semibold text-foreground">{event.titel}</h4>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-none shadow-lg">
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="pt-4 border-t">
                  ...
                  <p className="text-xl font-bold text-foreground">{rechnungen.length}</p>
                </div>
            ...
            <Card className="border-none shadow-lg">
              ...
              <CardContent className="p-0">
                ...
                <div className="divide-y max-h-96 overflow-y-auto">
                  ...
                  <div key={rechnung.id} className="p-4 hover:bg-muted transition-colors">
            ...
            <Card className="border-none shadow-lg">
              ...
              <CardContent className="p-6 space-y-4">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Events gebucht</p>
                  <p className="text-2xl font-bold text-foreground">{events.length}</p>
                </div>
                
                <div className="pt-4 border-t">
                  <p className="text-sm text-muted-foreground mb-1">Kundenseit</p>

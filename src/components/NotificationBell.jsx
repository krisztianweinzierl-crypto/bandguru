    ...
    <div className="relative flex-shrink-0">
      ...
      {showDropdown && (
        <>
          ...
          <div className="notification-dropdown fixed md:absolute right-4 md:right-0 mt-2 w-[calc(100vw-2rem)] md:w-80 bg-white border border-gray-200 rounded-xl shadow-2xl z-50 overflow-hidden">

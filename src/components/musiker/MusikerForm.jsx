        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start gap-6">
            <div className="relative">
              ...
              <label className="absolute -bottom-1 -right-1 w-8 h-8 bg-[#2E7D69] hover:bg-[#256B59] text-white rounded-full flex items-center justify-center cursor-pointer shadow-lg transition-colors">
                {uploadingImage ? (
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <Button type="submit" className="bg-[#2E7D69] text-primary-foreground px-4 py-2 text-sm font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow hover:bg-primary/90 h-9 from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700">

      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-6 mb-6 md:mb-8">
          ...
          <Card className="relative overflow-hidden border-none shadow-lg">
            ...
            <CardHeader className="pb-2 p-3 md:p-6">
              <div className="flex justify-between items-start">
                <CardTitle className="text-xs md:text-sm font-medium text-muted-foreground">Einnahmen</CardTitle>
          ...
          <Card className="relative overflow-hidden border-none shadow-lg">
            ...
            <CardContent className="px-3 pb-3 md:px-6 md:pb-6">
              <p className={`text-base md:text-xl xl:text-2xl font-bold truncate ${gewinn >= 0 ? 'text-blue-600' : 'text-orange-600'}`}>
          ...
          <Card className="relative overflow-hidden border-none shadow-lg">
            ...
            <CardContent className="px-3 pb-3 md:px-6 md:pb-6">
              <p className="text-base md:text-xl xl:text-2xl font-bold text-foreground">{offeneAngebote}</p>
              <p className="text-xs md:text-sm text-muted-foreground mt-1 md:mt-2">

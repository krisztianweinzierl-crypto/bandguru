        ...
        <CardContent className="p-6">
          {rechnungen.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <Button size="sm" onClick={() => navigate(createPageUrl('Rechnungen'))} className="text-white" style={{ backgroundColor: '#D96648' }}>
                <Plus className="w-4 h-4 mr-2" />Rechnung erstellen
              </Button>
            </div>
          )}
        ...
        <CardContent className="p-6">
          {ausgaben.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <Button size="sm" onClick={() => navigate(createPageUrl('Ausgaben'))} className="text-white" style={{ backgroundColor: '#D96648' }}>
                <Plus className="w-4 h-4 mr-2" />Ausgabe hinzufügen
              </Button>
            </div>
          )}
